...
def use_tf_data(path):
    ...
    checkpoint = ModelCheckpoint("all_classes\\model_all.h5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max',
...
plt.savefig("all_classes\\accuracy_graph.png")
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'validation'], loc='upper left')
plt.savefig("all_classes\\loss_graph.png")
plt.close()
